...
?>
    ...
    <div class="container">
        ...
        <div class="bg-white rounded shadow p-2 mt-4 mb-4" style="min-height:80vh">
            <div class="d-flex justify-content-between border-bottom">
                <h5>Create Resume</h5>
                <div>
                <a  class="text-decoration-none" style="cursor: pointer;" onclick="history.back()"><i class="bi bi-arrow-left-circle link-warning link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"></i> Back</a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="col-md-6">
                        ...
                        <input type="text" name="resume_title" value="resume<?=time()?>" placeholder="Web developer consultent" class="form-control" required>
                    </div>
                    <h5 class="mt-3 text-secondary"><i class="bi bi-person-badge"></i> Personal Information</h5>
                    <div class="col-md-6">
                        <label class="form-label" >Full Name</label>
                        <input type="text" name="Full_Name" placeholder="Name" class="form-control" required>
                    </div>
                   
                    <div class="col-md-6">
                        <label class="form-label" >Email</label>
                        <input type="email" name="email" placeholder="name@gmail.com" class="form-control" required>
                    </div>
                    <div class="col-12">
                        <label for="inputAddress" class="form-label"> Objective</label>
                        <textarea class="form-control" name="objective" id=""></textarea>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-12 text-end">
                        <button type="submit" class="btn btn-outline-warning"><i class="bi bi-floppy"></i> Add
                            Resume</button>
                    </div>
                </form>
            </div>
